...
public class SingleSelectCheckBoxs extends LinearLayout {
	...
	private ArrayList<GoodsStandard> mData = new ArrayList<GoodsStandard>();
	...
	private void initView() {
		View view = mLayoutInflater.inflate(R.layout.item_pop_view_single_select_chk,
				this);
		// 用来放很多checkbox的布局
	 ...
	 * @param data
	 */
	public void setData(ArrayList<GoodsStandard> data) {
		this.mData = data;
		initView();
	}
