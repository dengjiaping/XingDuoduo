 ...
 */
public class UserPswUpdateActivity extends Base2Activity implements
		OnClickListener {
	...
	private Handler handler = new Handler() {
		public void handleMessage(android.os.Message msg) {
			...
			case AppConfig.NET_SUCCED:// 请求数据成功(注册成功和注册失败，注册成功则请求个人信息并保存，然后退出界面，失败则留在该界面继续注册)
				...
				if (value.isSuccess()) {
					ToastUtil.ToastView(UserPswUpdateActivity.this,
							value.getMessage());
					// 获取用户信息
					getUserInfo();
				} else {
			...
			case AppConfig.NET_ERROR_NOTNET:// 无网络
				loadingdialog.dismiss();
				ToastUtil.ToastView(UserPswUpdateActivity.this, "网络连接失败，请重试");
				break;
	...
	public void getUserInfo() {
		HttpUrlProvider.getIntance().getUserInfo(UserPswUpdateActivity.this,
