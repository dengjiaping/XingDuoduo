...
import com.xiuman.xingduoduo.adapter.ImageViewPagerAdapter;
...
public class PostImgViewActivity extends Base2Activity implements
	...
	protected void initData() {
		...
		options = new DisplayImageOptions.Builder()
				...
				.showImageForEmptyUri(R.drawable.onloadong_post) // image连接地址为空时
				.showImageOnFail(R.drawable.onloadong_post) // image加载失败
	...
	protected void initUI() {
		adapter = new ImageViewPagerAdapter(this, imgs, options, imageLoader);
