 ...
 */
public class TaskDeleteCartBack implements HttpTaskListener {

	private Handler handler;

	public TaskDeleteCartBack(Handler handler) {
		super();
	...
	public void dataSucced(String result) {
		...
		msg.what = AppConfig.UPDATE_DELETE_SHOPPING_CART_GOODS;
		msg.obj = value;
