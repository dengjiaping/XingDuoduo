 ...
 * @描述：获取用户信息（并将用户信息保存为全局）
 * @author danding 2014-8-12
 */
public class TaskUserInfoBack implements HttpTaskListener {

	private Handler handler;

	public TaskUserInfoBack(Handler handler) {
		super();
	...
	public void dataSucced(String result) {
		ActionValue<User> value = new Gson().fromJson(result, ActionValue.class);
