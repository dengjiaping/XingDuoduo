 ...
 * @date：2014-7-29
 */
public class TaskCenterGoodsBack implements HttpTaskListener {
	 ...
	 * @param handler
	 */
	public TaskCenterGoodsBack(Handler handler) {
		super();
	...
	public void dataSucced(String result) {
		...
		msg.what = AppConfig.CENTER_GOODS_SUCCED;
		msg.obj = value;
	...
	public void dataError(String result) {
		Message msg = Message.obtain();
		msg.what = AppConfig.CENTER_GOODS_FAILD;
		handler.sendMessage(msg);
	}
