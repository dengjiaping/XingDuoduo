 ...
 * @date：2014-6-25
 */
public class GoodsStick implements Serializable {
	...
	public GoodsStick(String id, String thumbnailGoodsImagePath,
			...
			String goodtype_id, String metaDescription, boolean is_hot) {
		super();
		this.id = id;
	...
	public boolean equals(Object obj) {
		if (obj instanceof GoodsStick) {
			GoodsStick goods = (GoodsStick) obj;
