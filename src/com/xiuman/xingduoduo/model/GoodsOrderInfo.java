...
public class GoodsOrderInfo implements Serializable {
	...
	public GoodsOrderInfo(String productId, String goodId, String productName,
			String productPrice, String thumbnailGoodsImagePath,
			String smallGoodsImagePath, String specifications, int quanity,
			boolean isActivity) {
		super();
